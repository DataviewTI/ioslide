new IOService(
  ...
  function(self) {
    ...
    $("#text-shadow").attrchange(function(attrName) {
      ...
      if (attrName == "aria-pressed") {
        ...
        if (attr == "true") {
          ...
          applyTextShadow(
            $(".container-orbes").find(".orbe-active .apply-font")
          );
        } else {
          $(".container-text-shadow").setDisabled(true);
          $(".container-orbes")
            .find(".orbe-active .apply-font")
            ...
            self.dz.addModal({
              ...
              onShow: (params, obj) => {
                ...
                img
                  .removeClass("w-100")
                  .addClass("m-auto")
                  .css({ width: `${_w}px`, height: `${_h}px` });

                file.splits = [];

                setTimeout(function() {
                  file.splits.push(
                    Split(["#splita", "#splitb", "#splitc"], {
                      gutterSize: 5,
                      minSize: 100,
                    })
                  );
                ...
                for (let o in params.infos.data.orbs) {
                  ...
                  $("head")
                    .append(`<link href="https://fonts.googleapis.com/css?family=${__orb.font.replace(
                    " ",
                    "+"
                  )}"
                  ...
                  addOrbe({
                    ...
                    container: $(`[data-col=${__orb.col}]`)
                      .find(`[data-row=${__orb.row}]`)
                      .first(),
                    w: __orb.w,
                    h: __orb.h,
    ...
    self.wizardActions(function() {
      self.dz.copy_params.sizes.default = {
        w: $("#width").val(),
        h: $("#height").val(),
      };
...
function addOrbe(
  ...
  if (element == null) return null;
    ...
    element =
      p.container !== undefined ? `#${p.container.attr("id")}` : `#${element}`;

  new Orbe(element, p.content, (orb) => {
    orb._this.removeClass("invisible");

    if (!p.reload)
      //faz o bind somente se for objeto novo
      $("#font-select, #fsize, #o-animate, #o-speed, #o-delay").trigger(
        "change"
      );

    if (p.w !== undefined) orb._this.css("width", p.w + "px");

    if (p.h !== undefined) orb._this.css("height", p.h + "px");
    ...
    $(".container-orbes")
      ...
      .on("dblclick", (e) => {
        ...
        if (
          !orb._this.hasClass("editting") &&
          !orb._this.hasClass("animated")
        ) {
          let obj = $(e.target);
          $(".font-select")
            .parent()
          ...
          let ta = $(
            "<textarea type = 'text' class = 'w-100 h-100 orb-text-edit'>"
          );
          prop.forEach((a, b) => {
            ta.css(a, obj.css(a));
          });
    ...
    if (p.animate !== undefined) {
      ...
      if (p.speed !== undefined) setAnimationSpeed(p.speed, false);
      if (p.delay !== undefined) setAnimationDelay(p.delay, false);
    }

    $(".container-orbes")
      .find(".orbe-active .orbe-animate")
      .on("click", (e) => {
        let _orb = $(e.target)
          .parent()
          .parent();
    ...
    $(".container-orbes")
      .find(".orbe-active .orbe-editting")
      .on("click", (e) => {
        $(e.target)
          .parent()
          .parent()
    ...
    $(".container-orbes")
      .find(".orbe-active .orbe-save")
      .on("click", (e) => {
        $(".container-orbes").trigger("click");
      });

    $(".container-orbes")
      .find(".orbe-active .orbe-remove")
      .on("click", (e) => {
        $(e.target)
          .parent()
          .parent()
    ...
    $(".container-orbes")
      .find(".orbe-active .orb-text-center")
      .on("click", (e) => {
        let el = $(e.target)
          .parent()
          .parent()
          ...
          .parent()
          .find(".apply-font");
        el.removeClass("mr-0 ml-0 text-right text-left").addClass(
          "mx-auto text-center"
        );
      });

    $(".container-orbes")
      .find(".orbe-active .orb-text-left")
      .on("click", (e) => {
        let el = $(e.target)
          .parent()
          .parent()
          ...
          .parent()
          .find(".apply-font");
        el.removeClass("mx-auto ml-auto text-center text-right").addClass(
          "text-left"
        );
      });

    $(".container-orbes")
      .find(".orbe-active .orb-text-right")
      .on("click", (e) => {
        let el = $(e.target)
          .parent()
          .parent()
          ...
          .parent()
          .find(".apply-font");
        el.removeClass("mx-auto text-center text-left").addClass(
          "ml-auto text-right"
        );
      });

    $(".container-orbes")
      .find(".orbe-active .orb-text-middle")
      .on("click", (e) => {
        let el = $(e.target)
          .parent()
          .parent()
    ...
    $(".container-orbes")
      .find(".orbe-active .orb-text-bottom")
      .on("click", (e) => {
        let el = $(e.target)
          .parent()
          .parent()
...
function setAnimationSpeed(val) {
  ...
  } else _orb.removeAttr("data-speed");
}
...
function setAnimationDelay(val) {
  ...
  } else _orb.removeAttr("data-delay");
}
